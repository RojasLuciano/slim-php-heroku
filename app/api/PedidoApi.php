...
class PedidoApi extends Pedido implements IApiUsable
{
    ...
    public function CargarUno($request, $response, $args)
    {
        ...
        foreach ($arraypedidos as $pedido) {
            ...
            foreach ($arrayProducto as $producto) {
                ...
                $consumo->idPedido = $producto->idPedido;
        ...
        if ($codigo) {
            ...
            $empleadoTomaPedido = Empleado::TraerUnEmpleado($ArrayDeParametros['empleado']["id"]);
            $new_log = new Logger();
    ...
    {
        $empleado = Pedidos::Metricas();

        Pedidos::MostrarMetricas($empleado);
        //	print_r($empleado);
